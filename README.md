...
```bash
amazon-forecast-sample$ sam build --use-container
```
...
```bash
amazon-forecast-sample$ sam logs -n StockCheckerFunction --stack-name amazon-forecast-sample --tail
```
...
```bash
amazon-forecast-sample$ pip install pytest pytest-mock --user
amazon-forecast-sample$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name amazon-forecast-sample
```
